...
namespace Zenon {
    ...
    Core::Core(GameDataRef l_data, sf::Vector2f l_position, const std::vector<Enemy*>& l_nearestEnemies, Bezier& l_routePath) : Objective(l_data, l_position, l_nearestEnemies, l_routePath) {

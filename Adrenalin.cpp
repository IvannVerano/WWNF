...
namespace Zenon
{
    Adrenalin::Adrenalin(GameDataRef l_data, sf::Vector2f l_posicion, sf::Texture &l_textura, const std::vector<Hero*> &l_hero, int l_rango):Trampa(l_data),m_hero(l_hero)
    {
    ...
    void Adrenalin::Update(float dt)
    {
    ...
    void Adrenalin::AnimateApparition()
    {
    ...
    int Adrenalin::CalculateRec(int l_sum)
    {
        return 1;
    }

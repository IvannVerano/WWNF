...
namespace Zenon
{
    ...
    void GameOverState::Init()
    {
        ...
        m_getBackButton.setPosition(200,200);
        ...
        m_sendDataToServerButton.setPosition(400,200);
        
        m_failText.setString("Has perdido pichonaco");
    ...
    void GameOverState::SendDataToWebsite()
    {
        ...
        std::string fin = "\n";
        std::string body = init+result+fin;

...
${OBJECTDIR}/Attack.o: Attack.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Attack.o Attack.cpp
...
${OBJECTDIR}/Doxy.o: Doxy.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Doxy.o Doxy.cpp
...
${OBJECTDIR}/FaseSeleccionState.o: FaseSeleccionState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FaseSeleccionState.o FaseSeleccionState.cpp
...
${OBJECTDIR}/Fighter.o: Fighter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fighter.o Fighter.cpp
...
${OBJECTDIR}/Maps.o: Maps.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Maps.o Maps.cpp
...
${OBJECTDIR}/PlaneScene.o: PlaneScene.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlaneScene.o PlaneScene.cpp
...
${OBJECTDIR}/SplashState.o: SplashState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SplashState.o SplashState.cpp

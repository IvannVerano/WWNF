...
namespace Zenon {
    ...
    Doxy::Doxy(GameDataRef l_data, Enemy::TYPE l_type, sf::Vector2f l_position, const std::vector<Enemy*>& l_neighbors, const std::vector<Bezier>& l_routes, int l_path) : Enemy(l_data, l_type, l_position, l_neighbors), m_routes(l_routes) {
